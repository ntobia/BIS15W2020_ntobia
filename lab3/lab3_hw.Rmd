...
#lapply is fine, you can also use glimpse()
```
...
##Love how separated and tidy this is!
```{r}
...
##This question was a little unclear, it means the answer from the question (# 10) which is Regulus regulus, the Gold Crest. It also asks you to add a link to the markdown:

[Gold Crest](https://en.wikipedia.org/wiki/Goldcrest)
